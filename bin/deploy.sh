...
sudo docker pull 563057296362.dkr.ecr.ap-northeast-2.amazonaws.com/our-map-server/our-map-server:latest
...
sudo nohup docker run -p 80:8080 \
  ...
  563057296362.dkr.ecr.ap-northeast-2.amazonaws.com/our-map-server/our-map-server &
